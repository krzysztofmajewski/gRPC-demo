...
const {UserProfileRequest} = require('./demo_pb.js');
const {DemoServiceClient} = require('./demo_grpc_web_pb.js');
...
var demoService = new DemoServiceClient('http://'+window.location.hostname+':8080', null,
                                        null);
//                                      opts);

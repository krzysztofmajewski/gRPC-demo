 ...
 * @param {Object} ctors
 */
echoapp.EchoApp = function(demoService, ctors) {
...
echoapp.EchoApp.prototype.echo = function(msg) {
  ...
  var unaryRequest = new this.ctors.UserProfileRequest();
  unaryRequest.setMessage(msg);
  var call = this.demoService.echo(unaryRequest,
...
echoapp.EchoApp.prototype.echoError = function(msg) {
  ...
  var unaryRequest = new this.ctors.UserProfileRequest();
  unaryRequest.setMessage(msg);
  this.demoService.echoAbort(unaryRequest, {}, function(err, response) {
    if (err) {
      echoapp.EchoApp.addRightMessage('Error code: '+err.code+' "'+
                                      err.message+'"');
    }
